...
public class ImageTimelineAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ImageTimelineAdapter(Context context, OnItemClickListener itemClickListener) {
